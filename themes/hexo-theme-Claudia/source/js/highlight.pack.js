    ...
    return e.classNameAliases = s(e.classNameAliases || {}),
      function n(r, o) {
        ...
        [T, D, F, H].forEach((e => e(r, o))), e.compilerExtensions.forEach((e => e(r, o))),
          r.__beforeBegin = null, [L, B, P].forEach((e => e(r, o))), r.isCompiled = !0;
        let c = null;
  ...
  var te = (e => {
    ...
    function E(e, n, r, s) {
      ...
      function l() {
        ...
        for (; t;) {
          ...
          e = k.keywordPatternRe.lastIndex, t = k.keywordPatternRe.exec(S)
        }
        var i;
      ...
      function h(e, t) {
        return e.scope && "string" == typeof e.scope && M.openNode(y.classNameAliases[e.scope] || e.scope),
          e.beginScope && (e.beginScope._wrap ? (M.addKeyword(S, y.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap),
            S = "") : e.beginScope._multi && (u(e.beginScope, t), S = "")), k = Object.create(e, {
            parent: {
              value: k
            }
          }), k
      ...
      function p(e) {
        return 0 === k.matcher.regexIndex ? (S += e[0], 1) : (I = !0, 0)
      }
      ...
      try {
        ...
        return w(n.substr(j)), M.closeAllNodes(), M.finalize(), O = M.toHTML(), {
          language: e,
          value: O,
          relevance: R,
          illegal: !1,
    ...
    function x(e, n) {
      ...
      const i = (e => {
        ...
        r = n.filter(v).filter(k).map((t => E(t, e, !1)));
      r.unshift(i);
      const s = r.sort(((e, t) => {
  ...
  var e = (() => {
    ...
    return o => {
      ...
      const x = {
        ...
        M = {
          match: [/const|var|let/, /\s+/, b, /\s*/, /=\s*/, l.lookahead(C)],
          className: {
            1: "keyword",
            3: "title.function"
          },
      ...
      const n = e.regex,
        ...
        l = {
          ...
          variants: [{
            ...
            contains: [e.BACKSLASH_ESCAPE, s, r, t]
          }, {
            begin: /([fF][rR]|[rR][fF]|[fF])"""/,
            end: /"""/,
            contains: [e.BACKSLASH_ESCAPE, s, r, t]
        ...
        g = {
          ...
          variants: [{
            ...
            excludeEnd: !0,
            keywords: i,
            contains: ["self", s, c, l, e.HASH_COMMENT_MODE]
          }]
        };
      return t.contains = [l, c, s], {
        name: "Python",
    ...
    return e => {
      const n = e.regex,
        ...
        o = [t, {
          ...
          className: "function",
          begin: n.concat(/def\s+/, n.lookahead(a + "\\s*(\\(|;|$)")),
          relevance: 0,
          keywords: "def",
          end: "$|;",
          contains: [e.inherit(e.TITLE_MODE, {
  ...
  var e = (() => {
    ...
    return a => {
      const n = a.regex,
        ...
        s = [a.APOS_STRING_MODE, a.QUOTE_STRING_MODE];
      return {
        name: "CSS",
        case_insensitive: !0,
        illegal: /[=|'\$]/,
  ...
  var e = (() => {
    ...
    function o(o) {
      const l = o.regex,
        ...
        N = [o.APOS_STRING_MODE, o.QUOTE_STRING_MODE, A, p, _, E];
      y.contains = N.concat({
        begin: /\{/,
        end: /\}/,
        keywords: g,
      ...
      const I = {
        ...
        M = {
          match: [/const|var|let/, /\s+/, d, /\s*/, /=\s*/, l.lookahead(T)],
          className: {
            1: "keyword",
            3: "title.function"
          },
    ...
    return t => {
      const s = o(t),
        r = ["any", "void", "number", "boolean", "string", "object", "never", "enum"],
        l = {
          beginKeywords: "namespace",
          end: /\{/,
          excludeEnd: !0,
